...
<body id="sample">
  <div class="textColumn">
    <h1>Welcom to ICT-6 Course</h1>
    <p>This is my first beans talk app</p>
    <p>It is using Python</p>
  </div>
  ...
  <div class="linksColumn"> 
    ...
    <li><a href="http://docs.amazonwebservices.com/elasticbeanstalk/latest/dg/create_deploy_Python_django.html">Third Link</a></li>
